        ...
        for (let brewery of breweriesDisplay) {
            ...
            service.findPlaceFromQuery(request, function (results, status) {
                ...
                let requestDetailed = {
                    ...
                    fields: ['geometry', "photo", "formatted_address", "formatted_phone_number", "rating", "website", "opening_hours"]
                ...
                service.getDetails(requestDetailed, function (place, status) {
                    ...
                    var datainfo = $(this).dataFromPlaces;
                })
            ...
            function buildIWContent(detailsFromLocation) {
        
               
              //  document.getElementById('iw-url').innerHTML = '<b><a href="' + detailsFromLocation.url +
              //      '">' + detailsFromLocation.name + '</a></b>';
                document.getElementById('iw-address').textContent = detailsFromLocation.formatted_address;
                
                
                if (detailsFromLocation.formatted_phone_number) {
                    document.getElementById('iw-phone-row').style.display = '';
                    document.getElementById('iw-phone').textContent = detailsFromLocation.formatted_phone_number;
                } else {
                ...
                if (detailsFromLocation.rating) {
                    var ratingHtml = '';
                   for (var i = 0; i < 5; i++) {
                        if (detailsFromLocation.rating < (i + 0.5)) {
                            ratingHtml += '&#10025;';
                        } else {
                           ratingHtml += '&#10029;';
                       }
               ...
               // if (detailsFromLocation.website) {
                //    var fullUrl = detailsFromLocation.website;
               //     var website = hostnameRegexp.exec(detailsFromLocation.website);
                //    if (website === null) {
                 //       website = 'http://' + detailsFromLocation.website + '/';
                 //       fullUrl = website;
                //    }
